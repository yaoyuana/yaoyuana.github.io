...
$(function () {
  ...
  $('pre').wrap('<div class="code-area' + (expandDefault ? '' : ' code-closed') + '" style="position: relative"></div>');
  ...
  if (!expandDefault) {
    $('.code-expand').siblings('pre').find('code').hide();
  }
  ...
  // hexo-toc 把 id 写在标题里的 span 上，主题 toc 助手因此生成了没有 href 的目录
